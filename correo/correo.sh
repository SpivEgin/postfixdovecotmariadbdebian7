...
# Licencia GPL. Kaotika.
# Fecha de creación: 14.11.2013 Probado en Debian 7 wheezy, fuente de referencia: https://library.linode.com/email/postfix/postfix2.9.6-dovecot2.0.19-mysql 
...
echo "GRANT SELECT ON mailserver.* TO 'mailuser'@'127.0.0.1' IDENTIFIED BY '$respuestamailuser'; FLUSH PRIVILEGES;" | mysql -uroot -p$passmariadb



# CREACIÓN de TABLAS
echo -e "Creando tabla virtual_domains... \n"
echo "CREATE TABLE mailserver.virtual_domains (id int(11) NOT NULL auto_increment,name varchar(50) NOT NULL,PRIMARY KEY (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;" | mysql -uroot -p$passmariadb

echo -e "Creando tabla virtual_users... \n"
...
echo -e "Autogeneración del certificado y asginación de permisos...\n"
...
echo -e "\nCopia finalizada\n"
echo -e "Mostrando resultados...(Si la copia se ha realizado correctamente verá 6 archivos con terminación .backup)\n"
...
echo -e "Felicidades su Postfix+Dovecot+MariaDB han sido configurados. Comenzamos\n"
